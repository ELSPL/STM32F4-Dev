...
*
* @section section2 Example 5 :
*    Objective: Write a program for alarm Interrupt for specific date/time
*
* @section section3 Program Description:
*    This program demonstrates RTC alarm Interrupt for specific date/time
*
...
*    RTC alarm generates interrupt and toggle LED.
*\n
*\n
*******************************************************************************/
