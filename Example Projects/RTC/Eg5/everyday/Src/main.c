/******************************************************************//**
* @file   main.c
* @brief  Write a program for alarm Interrupt for specific date/time
* @version  v1.0
* @date   May 30, 2015
...
int main(void)
{
  ...
  BSP_RTC_Alarm_Init(AlarmA,0,0,5,RTC_ALARMDATEWEEKDAYSEL_WEEKDAY); //Generate alarm interrupt
...
void HAL_RTC_AlarmAEventCallback(RTC_HandleTypeDef *hrtc)
{
  ...
  A.AlarmDateWeekDay = i;
  A.Alarm = RTC_ALARM_A;
  HAL_RTC_SetAlarm_IT(&hrtc_bsp, &A, FORMAT_BIN);
  i++;
  if (i == 7)
  {
    i = 1;
