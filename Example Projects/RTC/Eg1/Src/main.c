/******************************************************************//**
* @file   main.c
* @brief  Write a program to set and display RTC Time and Date
* @version  v1.0
* @date   May 30, 2015
...
int main(void)
{
  ...
  /* USER CODE BEGIN 3 */
    ...
    uprintf("\x1b[2;1H %d02 : %d02 : %d02 : %d04",Tim.Hours,Tim.Minutes,Tim.Seconds,Tim.SubSeconds);
    uprintf("\x1b[3;1H %d02 : %d02 : %d04",Dat.Date,Dat.Month,Dat.Year+2000);
