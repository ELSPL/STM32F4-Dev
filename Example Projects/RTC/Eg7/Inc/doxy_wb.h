...
*
* @section section2 Example 7 :
*    Objective: Write a program to demonstrate RTC Time stamp
*
* @section section3 Program Description:
*    This program demonstrates RTC time stamp feature
*
...
*    RTC time stamp interrupt will be generated when an event is detected on pin PC13 and LED4 will blink and time stamp register will be updated with the current time.
*\n
*\n
*******************************************************************************/
