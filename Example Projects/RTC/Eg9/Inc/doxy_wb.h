...
*
* @section section2 Example 9 :
*    Objective: Write a program to use RTC as stopwatch with 10 time lapse storage.
*
* @section section3 Program Description:
*    This program demonstrates RTC time function used for stopwatch
*
...
*    RTC Time function will work properly with 10 time lapse storage in RTC backup registers.
*\n
*\n
*******************************************************************************/
