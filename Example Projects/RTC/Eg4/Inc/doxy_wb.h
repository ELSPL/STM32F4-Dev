...
*
* @section section2 Example 4 :
*    Objective: Write a program to generate 1s counter interrupt
*
* @section section3 Program Description:
*    This program demonstrates RTC wakeup timer to generate 1 second counter interrupt
*
...
*    RTC wakeup timer generate per second interrupt and toggle LED.
*\n
*\n
*******************************************************************************/
