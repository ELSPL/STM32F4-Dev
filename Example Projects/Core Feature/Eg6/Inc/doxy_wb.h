...
*    Objective:  Write a program to enter system in Standby(Deep PowerDown) mode and wake-up by using wakeup key interrupt.
*
* @section section3 Program Description:
*    This program demonstrates the Standby(Deep sleep) mode of system and wakeup using wakeup button interrupt
*
...
*    When UART input is given the target board will enter in Standby mode and wakeup using wakeup button.
*\n
*\n
*******************************************************************************/
