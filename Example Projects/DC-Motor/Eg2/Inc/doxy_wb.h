...
*    Objective:  Program to interface of DC motor and demonstrate Anti clock-wise movement.
*
* @section section3 Program Description:
*    This program demonstrates interfacing of DC Motor and demonstrate Anti Clock-wise movement
*
...
*    You will see the DC Motor rotating in anti-clockwise direction
*\n
*\n
*******************************************************************************/
