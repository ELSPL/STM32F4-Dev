...
*    Objective: 1. Write a program to interface single 7segment and display any digit on that.
*
* @section section3 Program Description:
*    This program demonstrates 7 segment interface and display digit on it. 
*
...
*    On first 7 segment you will see the digit 2.
*\n
*\n
*******************************************************************************/
