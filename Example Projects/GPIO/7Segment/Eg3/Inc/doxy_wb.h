...
*    Objective: Write a program to display digits 9 to 0 on 7segment display on Seg2.
*
* @section section3 Program Description:
*    This program demonstrates 7 segment interface and display 9 to 0 digit on it.
*
...
*    On second 7 segment you will see the digit 9 to 0.
*\n
*\n
*******************************************************************************/
