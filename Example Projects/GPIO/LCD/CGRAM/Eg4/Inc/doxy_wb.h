...
*    Objective: Program to display Empty Square for one character.
*
* @section section3 Program Description:
*    This program demonstrates interfacing of LCD display and display empty square on it
*
...
*    On LCD display you will see a empty square for only one character on starting location
*\n
*\n
*******************************************************************************/
