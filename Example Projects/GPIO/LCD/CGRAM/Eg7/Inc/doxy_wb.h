...
*    Objective: Program to display Full Triangle for one character.
*
* @section section3 Program Description:
*    This program demonstrates interfacing of LCD display and display full triangle on it
*
...
*    On LCD display you will see a full triangle for only one character on starting location
*\n
*\n
*******************************************************************************/
