...
*    Objective: Program to display blinking message (4bit).
*
* @section section3 Program Description:
*    This program demonstrates interfacing of LCD display and display blinking message on it.
*
...
*    On LCD display you will see blinking message.
*\n
*\n
*******************************************************************************/
