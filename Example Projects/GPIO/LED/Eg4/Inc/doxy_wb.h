...
*    Objective: Write a program to glow LEDs in binary counter fashion.
*
* @section section3 Program Description:
*    This program demonstrates glowing LEDs in Binary Counter pattern on ASK-25.
*
...
*    LED1 to LED8 glows in Binary Counter pattern on ASK25.
*\n
*\n
*******************************************************************************/
