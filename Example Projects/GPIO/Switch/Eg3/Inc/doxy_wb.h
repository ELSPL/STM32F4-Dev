...
*    Objective: Write a program to interface switches and use software debouncing.
*
...
*    LED will On and Off with very less fluctuation when a switch is pressed repetitively
*\n
*\n
*******************************************************************************/
