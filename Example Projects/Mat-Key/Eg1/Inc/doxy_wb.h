...
*    Objective:  Write a program to display key code of the key pressed on LCD.
*
* @section section3 Program Description:
*    This program demonstrates interfacing of LCD display and Matrix keyboard and display key code on LCD Display
*
...
*    On LCD display you will see key code of the pressed key
*\n
*\n
*******************************************************************************/
