...
*    Objective:  Write a program to display the corresponding key pressed on LCD.
*
* @section section3 Program Description:
*    This program demonstrates interfacing of LCD display and Matrix keyboard and display key number on LCD Display
*
...
*   | P1.32 GPIOE.14      | D6                 |
*   | P1.33 GPIOE.15      | D7                 |
*   | P1.25 GPIOE.7       | Matrix key         |
*   | P2.13 GPIOE.4       | Matrix key         |
*   | P2.14 GPIOE.5       | Matrix key         |
*   | P2.11 GPIOE.6       | Matrix key         |
*
*
...
*    On LCD display you will see key number of the pressed key
*\n
*\n
*******************************************************************************/
