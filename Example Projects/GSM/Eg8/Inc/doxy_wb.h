...
*    Objective: Write a program to give missed call.
*
* @section section3 Program Description:
*    This program checks the connection between STM32F4 and GSM module.
*
...
*    GSM module will give a missed call to given number.
*\n
*\n
*******************************************************************************/
