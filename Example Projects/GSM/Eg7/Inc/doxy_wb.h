...
*    Objective: Write a program to find the contact from the SIM card memory.
*
* @section section3 Program Description:
*    This program will find the contact form the SIM card memory.
*
...
*    GSM module will find the contact from the SIM card memory.
*\n
*\n
*******************************************************************************/
