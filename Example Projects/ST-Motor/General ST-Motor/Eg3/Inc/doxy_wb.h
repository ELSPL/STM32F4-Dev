...
*    Objective:  Program to interface of Stepper Motor and demonstrate fixed rotation of motor.
*
* @section section3 Program Description:
*    This program demonstrates interfacing of Stepper Motor and demonstrate Clock-wise movement of 90 degree
*
...
*    You will see the Stepper Motor rotating fix 90 degree in clockwise direction with 60 ms delay
*\n
*\n
*******************************************************************************/
