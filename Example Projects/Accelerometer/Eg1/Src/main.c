/******************************************************************//**
* @file   main.c
* @brief  Write a program to use Accelerometer
* @version  v1.0
* @date   Apr 16, 2015
...
//    trace_printf("%05d %05d %05d\n\r",data[0],data[1],data[2]);
    uprintf("\x1b[2;1H X= %d05  Y= %d05  Z= %d05",data[0],data[1],data[2]); // display X Y Z(g),
                                                                            // Tilting the device will
                                                                            // will change the X Y Z
    HAL_Delay(500);
    uprintf("\x1b[2;2K"); // clear screen
