/******************************************************************//**
* @file   main.c
* @brief  Write a program to Generate Triangular wave.
* @version  v1.0
* @date   Apr 16, 2015
...
int main(void)
{
  ...
  BSP_DAC_Init(DAC_CHANNEL_2, DAC_TRIGGER_SOFTWARE);    //12-bit right alignment
  BSP_DAC_TriangularWave(DAC_CHANNEL_2);
  /* USER CODE END 2 */
  ...
  /* USER CODE BEGIN 3 */
//    hdac_bsp.Instance->SWTRIGR = DAC_SWTRIGR_SWTRIG1;          //when channel 1 is selected
    hdac_bsp.Instance->SWTRIGR = DAC_SWTRIGR_SWTRIG2;          //when channel 2 is selected
