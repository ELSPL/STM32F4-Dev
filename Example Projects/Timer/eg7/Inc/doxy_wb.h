...
*    Objective: Write a program to generate PWM signal using Timer and vary the brighness of a Led. (use edge align mode)(TImer4).
*
* @section section3 Program Description:
*    This program demonstrates generation of PWM signal using general timer.
*
...
*    200HZ PWM signal will be generated on the Timer4 channel1 port pin.
*\n
*\n
*******************************************************************************/
