...
*    Objective: Write a program to generate PWM signal using Timer and update duty cycle and display on DSO(Timer2).
*
...
*    200HZ PWM signal will be generated on the Timer2 channel1 port pin.
*\n
*\n
*******************************************************************************/
