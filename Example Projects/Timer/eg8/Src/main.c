/******************************************************************//**
* @file   main.c
* @brief  Write a program to generate PWM signal using Timer and update duty cycle and display on DSO(Timer2).
* @version  v1.0
* @date   May 30, 2015
...
int main(void)
{
  ...
  BSP_PWM_Config(&htim2_gen,TIM_CH1,200,2500,PWM_EDGE_ALIGN_MODE);
  /* USER CODE END 2 */
