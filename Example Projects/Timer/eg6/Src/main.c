/******************************************************************//**
* @file   main.c
* @brief  Write a Program to generate specific frequency a timer and capture it with timer in transition mode and display the frequency captured(timer5 and timer14).
* @version  v1.0
* @date   May 30, 2015
