...
*
* @section section2 Example12 :
*    Objective: Write a program to generate complimentary PWM output in Edge align mode without deadtime(Timer1)
*
* @section section3 Program Description:
*    This program demonstrates generation of complimentary PWM signal using advanced timer in edge align mode without deadtime.
*
...
*    20KHZ complimentary PWM signal will be generated on the Timer8 channel1N port pin in edge align mode without deadtime.
*\n
*\n
*******************************************************************************/
