...
*
* @section section2 Example13 :
*    Objective: Write a program to generate complimentary PWM output in center align mode with deadtime(Timer1)
*
* @section section3 Program Description:
*    This program demonstrates generation of complimentary PWM signal using advanced timer in center align mode with deadtime.
*
...
*    10KHZ complimentary PWM signal will be generated on the Timer1 channel1N port pin in center align mode with deadtime.
*\n
*\n
*******************************************************************************/
