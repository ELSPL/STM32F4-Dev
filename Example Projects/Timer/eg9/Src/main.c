/******************************************************************//**
* @file   main.c
* @brief  Write a program to generate melody on Buzzer using Timer as PWM. (Timer7)
* @version  v1.0
* @date   May 30, 2015
...
int main(void)
{
  ...
  /*initialize Buzzer */
  BSP_Buzzer_Init(GPIOA,GPIO_PIN_1);
  trace_printf("Mario Tune ");
  /* play the melody on GPIOC pin 7 */
  BSP_Play_Melody();
  /* USER CODE END 2 */
