/******************************************************************//**
* @file   main.c
* @brief  Write a program to Write and Read Page of I2C based EEPROM (ASK-25A)
* @version  v1.0
* @date   Apr 16, 2015
...
int main(void)
{
  ...
  ASK25_AT24C16_Write(0x0000,page,sizeof(page));

  /* Provide address range */
  ASK25_AT24C16_Display_Loc(0x0000,0x00FF);
