...
*    Objective: Write a program to transmit character string using UART6 (Interrupt).
*
* @section section3 Program Description:
*    This program transmits character string using UART6
*
...
*    Character string will be displayed on hyper terminal utility.
*\n
*\n
*******************************************************************************/
