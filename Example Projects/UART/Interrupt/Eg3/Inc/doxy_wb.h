...
*    Objective: Write a program to receive a single character using UART6 (Interrupt).
*
* @section section3 Program Description:
*    This program receives single character and displayed back on com-port utility using UART6
*
...
*    Character will be received and echoed back on hyper terminal utility.
*\n
*\n
*******************************************************************************/
