...
*    Objective: Write a program to receive string and display using UART6 (Interrupt).
*
* @section section3 Program Description:
*    This program receives character string and displayed back on com-port utility using UART6
*
...
*    Character string will be received and echoed back on hyper terminal utility.
*\n
*\n
*******************************************************************************/
