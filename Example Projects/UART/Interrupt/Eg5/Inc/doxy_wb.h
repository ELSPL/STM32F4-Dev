...
*    Objective: Write a program to use std. input and output functions using UART6 (Interrupt).
*
* @section section3 Program Description:
*    This program will display entered character in different format using standard I/O function using uart6.
...
*    It will display entered character in different format and receive a string and echo back to Hyper terminal utility.
*\n
*\n
*******************************************************************************/
