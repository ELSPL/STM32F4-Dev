...
*    Objective: Write a program to use ADC1 and ADC2 in Dual interleaved mode.
*
* @section section3 Program Description:
*    This program demonstrates dual mode analog to digital signal conversion using DMA with interleaved mode
*
