/******************************************************************//**
* @file   main.c
* @brief  Write a program to use ADC conversion in interrupt mode, to vary the speed of DC motor.
* @version  v1.0
* @date   Apr 16, 2015
...
int main(void)
{
  ...
  BSP_PWM_Config(&htim2_gen,TIM_CH1,200,2000,PWM_EDGE_ALIGN_MODE);

  /* Initialize ADC */
  BSP_ADC_Init(&hadc_bsp3,ADC_IN10,1,Indepenent_Mode);

  /* Start ADC */
  HAL_ADC_Start_IT(&hadc_bsp3);
  /* USER CODE END 2 */
...
{
  __HAL_TIM_SET_COMPARE(&htim2_gen,TIM_CH1,(65000/(1000000/pulsewidth_us)));
}
void HAL_ADC_ConvCpltCallback(ADC_HandleTypeDef* hadc)
{
  pulsewidth_us = HAL_ADC_GetValue(hadc);
}
/* USER CODE END 4 */
