/******************************************************************//**
* @file   main.c
* @brief  Write a program to use ADC conversion in interrrupt mode.
* @version  v1.0
* @date   Apr 16, 2015
...
int main(void)
{
  ...
  /* USER CODE BEGIN 2 */
  BSP_ADC_Init(&hadc_bsp2,ADC_IN0,1,Indepenent_Mode);
  HAL_ADC_Start_IT(&hadc_bsp2);   // Start ADC2 with interrupt
