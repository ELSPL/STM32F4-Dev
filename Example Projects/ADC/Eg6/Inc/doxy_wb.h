...
*    Objective: Write a program to Use ADC1, ADC2 and ADC3 in Triple interleaved mode and DMA mode2.
*
* @section section3 Program Description:
*    This program demonstrates Triple mode analog to digital signal conversion using DMA with interleaved mode
*
