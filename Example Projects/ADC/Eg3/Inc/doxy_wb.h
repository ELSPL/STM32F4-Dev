...
*    Objective: Write a program to use ADC conversion and transfer data with DMA continuously.
*
* @section section3 Program Description:
*    This program demonstrates analog to digital signal conversion using DMA
*
