/******************************************************************//**
* @file   main.c
* @brief  Write a program for Dual mode ADC conversion with DMA on two groups of ADC channels(Regular Simultaneous Mode).
* @version  v1.0
* @date   Apr 16, 2015
...
int main(void)
{
  ...
  /* USER CODE BEGIN 2 */
  /* Initialize ADC */
  BSP_ADC_Init(&hadc_bsp1,ADC_IN0,1,Dual_Mode_REGSIMULT);
  BSP_ADC_Init(&hadc_bsp2,ADC_IN0,1,Dual_Mode_REGSIMULT);
