...
*    Objective: Write a program to display value 45 using both segments.
*
* @section section3 Program Description:
*    This program demonstrates 7 segment interface and display digits using both 7 Segement.
*
...
*    On 7 segments you will see the digit 45.
*\n
*\n
*******************************************************************************/
