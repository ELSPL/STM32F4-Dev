...
*    Objective:  Program to interface of Stepper Motor and demonstrate Clock-wise movement.
*
* @section section3 Program Description:
*    This program demonstrates interfacing of Stepper Motor and demonstrate Clock-wise movement
*
...
*    You will see the Stepper Motor rotating in clockwise direction with 60 ms delay
*\n
*\n
*******************************************************************************/
