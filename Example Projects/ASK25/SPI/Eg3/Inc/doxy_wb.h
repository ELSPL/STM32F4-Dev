...
*    Objective:  Write a program to Write and Read array SPI based EEPROM.
*
* @section section3 Program Description:
*    This program demonstrates interfacing of EEPROM using SPI protocol and write and read array on EEPROM.
*
