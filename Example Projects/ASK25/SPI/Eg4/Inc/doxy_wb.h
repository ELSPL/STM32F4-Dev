...
*    Objective:  Write a program to Write and Read page of SPI based EEPROM.
*
* @section section3 Program Description:
*    This program demonstrates interfacing of EEPROM using SPI protocol and write and read page on EEPROM.
*
...
*    Data on the EEPROM will be shown on Com-port
*\n
*\n
*******************************************************************************/
