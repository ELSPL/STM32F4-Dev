...
*    Objective:  Write a program to Write and Read character to SPI based EEPROM.
*
* @section section3 Program Description:
*    This program demonstrates interfacing of EEPROM using SPI protocol and write and read character on EEPROM.
*
...
*    Data you have entered in EEPROM will be shown on Com-port
*\n
*\n
*******************************************************************************/
