/******************************************************************//**
* @file   main.c
* @brief  Write a program to Write and Read character to SPI based EEPROM
* @version  v1.0
* @date   Apr 16, 2015
...
int main(void)
{
  ...
  ASK25_25AA160A_Write_Byte(0x0005,'A');
  read_data = ASK25_25AA160A_Read_Byte(0x0005);
  vuprintf("Data at address 0x0005: %c",read_data);
