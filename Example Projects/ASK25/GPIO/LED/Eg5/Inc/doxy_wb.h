...
*    Objective: Write a program to glow LEDs from Left to Right.
*
* @section section3 Program Description:
*    This program demonstrates glowing LEDs from left to right on ASK-25.
*
...
*    LED1 to LED8 glows left to right pattern on ASK25.
*\n
*\n
*******************************************************************************/
