...
*
* @section section2 Example 09 :
*    Objective: Write a program to blink Led PD13 with GPIO interrupt
*               and use SysTick delay with Rising Edge on PA.0 Key
*
* @section section3 Program Description:
*    This program demonstrates on board Switch and LED3 interface using External interrupt.
*
