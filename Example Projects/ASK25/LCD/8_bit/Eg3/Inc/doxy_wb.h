...
*    Objective:  Program to display alphabet ‘A’ and ‘B’ at different locations on the LCD (8bit).
*
* @section section3 Program Description:
*    This program demonstrates interfacing of LCD display and display characters on it.
*
...
*    On LCD display you will see character A and B.
*\n
*\n
*******************************************************************************/
