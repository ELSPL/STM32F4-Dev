...
*    Objective: Program to display vertical Line for only one character.
*
* @section section3 Program Description:
*    This program demonstrates interfacing of LCD display and display vertical line on it
*
...
*    On LCD display you will see a vertical line for only one character on starting location
*\n
*\n
*******************************************************************************/
