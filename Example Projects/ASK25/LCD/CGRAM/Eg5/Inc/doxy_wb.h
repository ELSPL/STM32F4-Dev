...
*    Objective: Program to display Full Square for one character.
*
* @section section3 Program Description:
*    This program demonstrates interfacing of LCD display and display full square on it
*
...
*    On LCD display you will see a full square for only one character on starting location
*\n
*\n
*******************************************************************************/
