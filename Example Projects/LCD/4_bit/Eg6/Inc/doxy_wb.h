...
*    Objective: Program to display two line messages (4bit).
*
* @section section3 Program Description:
*    This program demonstrates interfacing of LCD display and display character on it.
*
...
*    On LCD display you will see string EDUTECH in first line and SYSTEMS in second line.
*\n
*\n
*******************************************************************************/
