...
*    Objective: Program to display string of character (say your name) at default cursor position (8bit).
*
* @section section3 Program Description:
*    This program demonstrates interfacing of LCD display and display string on it.
*
...
*    On LCD display you will see string EDUTECH.
*\n
*\n
*******************************************************************************/
